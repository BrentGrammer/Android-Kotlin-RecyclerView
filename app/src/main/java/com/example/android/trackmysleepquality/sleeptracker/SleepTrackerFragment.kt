...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // passing in and using the view model lifecycle owner will ensure that the observer is only around when the RecyclerView is still on screen
        sleepTrackerViewModel.nights.observe(viewLifecycleOwner, Observer {
            it?.let {
                // this resets data on the adapter when the list changes in the view model
                // submitList is a helper that comes with ListAdapter which the Adapter uses to manage the list
                // this method will diff new list with old one and make all necessary changes on recyclerview
